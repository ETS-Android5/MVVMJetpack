...
import com.elab.libarch.utils.StatusBarUtils;
import com.elab.libarch.utils.ToastUtils;
import com.elab.libview.R;
import com.elab.libview.loading.AVLoadingDialog;


public abstract class BaseNoManagerActivity<B extends ViewDataBinding> extends AppCompatActivity {
    ...
    protected BaseNoManagerActivity<B> setToolbar(String titletv, boolean back) {
